          ...
          <W>
            ...
            <div className="svc-grid">
              {services.map((svc) => (
                <div
                  ...
                  style={{
                    padding: "2.5rem",
                    background: bgMode === "light" ? "#faf8f5" : DARK.card,
                    border: `1px solid ${bgMode === "light" ? LIGHT.cardBorder : DARK.cardBorder}`,
                    borderRadius: ".25rem",
                    display: "flex",
                    flexDirection: "column",
                ...
                >
                  ...
                  >
                    ...
                    <span
                      className="material-symbols-outlined"
                      style={{ color: "#C5A059", fontSize: 32 }}
                    >
                      {svc.icon}
                    </span>
                  </div>
                  ...
                  <div
                    style={{
                      marginTop: "auto",
                      paddingTop: "1rem",
                      borderTop: `1px solid ${bgMode === "light" ? LIGHT.border : DARK.border}`,
                    }}
                  >
                    <button
                      style={{
            ...
            <div
              style={{
                ...
                padding: "2.5rem",
                background:
                  bgMode === "light" ? "#ebe7e0" : "rgba(197,160,89,.06)",
