...
const services = [
  {
    ...
    tags: ["Regenerative & Organic Farming","Agroforestry & Permaculture","Medicinal Plantations","Precision & Climate-Smart Farming","Soil Health & Biodiversity Restoration","Water Conservation & Efficient Irrigation","Carbon Sequestration Systems","Agrivoltaics as a Service"],
    img: "/pictures/services-agriculture.png",
  },
  {
    num: "02", icon: "wb_sunny",
    ...
    tags: ["Agrivoltaics (Solar + Farming)","Solar & Wind Energy Solutions","Smart Energy Storage & Infrastructure","Green Hydrogen & CBG Ecosystems","Multi-Revenue Land Models","Hybrid & Co-Located Energy Models","P2P & Smart Energy Contracts","Long-Term Energy Security"],
  ...
  },
  {
    ...
    tags: ["Biophilic Architecture","Eco-Conscious Community Development","Smart Climate-Resilient Planning","Wellness-Centric Living Spaces","Eco Villas & Resorts","Direct Farm-to-Home Systems","Water & Waste Management","Climate-Resilient & Future-Ready Designs"],
...
export default function ServicesAndTechnologyPage() {
  ...
  return (
    <>
      ...
      <div ref={pageRef} style={{ width: "100%", background: "#000", color: "#fff", overflowX: "hidden" }}>
        ...
        <section style={{ position: "relative", width: "100%", minHeight: "100vh", display: "flex", flexDirection: "column", justifyContent: "flex-end", overflow: "hidden" }}>
          <div style={{ position: "absolute", inset: 0, zIndex: 0 }}>
            <img src="/pictures/vision-split.png" alt="Hero" style={{ width: "100%", height: "100%", objectFit: "cover", opacity: 0.88 }} />
          ...
          <div className="svc-hero-eyebrow">
            ...
            <span style={{ fontFamily: "var(--font-label)", fontSize: ".55rem", fontWeight: 700, letterSpacing: ".28em", textTransform: "uppercase", color: "rgba(255,255,255,.55)" }}>Our Methodology</span>
            <span style={{ width: 32, height: 1, background: "#C5A059", display: "inline-block" }} />
          </div>
            ...
            <W>
              <div ref={heroRef} className="svc-hero-content">
                <div style={{ maxWidth: 720 }}>
                  <h1 className="h-anim" style={{ fontFamily: "var(--font-epilogue),sans-serif", fontWeight: 800, fontSize: "clamp(3rem,4vw,5rem)", lineHeight: 1.0, textTransform: "uppercase", letterSpacing: "-.04em", color: D.heading, marginBottom: "1.75rem", opacity: 0 }}>
                    Three Verticals,<br /><em style={{ fontStyle: "normal", color: "#C5A059" }}>One Vision.</em>
                  </h1>
                  <p className="h-anim" style={{ color: D.body, lineHeight: 1.8, fontSize: "clamp(.9rem,1.2vw,1.05rem)", maxWidth: 520, opacity: 0 }}>
                ...
                <div className="h-anim" style={{ flexShrink: 0, maxWidth: 300, width: "100%", borderRadius: ".25rem", padding: "2.5rem", opacity: 0, background: "rgba(19,19,19,.85)", border: "1px solid rgba(255,255,255,.08)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)" }}>
                  <span style={{ display: "block", fontFamily: "var(--font-label)", fontSize: ".55rem", fontWeight: 700, letterSpacing: ".22em", textTransform: "uppercase", color: "#C5A059", marginBottom: "1rem" }}>Core Philosophy</span>
                  <p style={{ fontFamily: "var(--font-epilogue),sans-serif", fontStyle: "italic", color: D.body, lineHeight: 1.7, fontSize: ".9rem" }}>
        ...
        <section id="services" ref={servicesRef} style={{ background: "transparent", padding: "clamp(4rem,8vw,8rem) 0" }}>
          <W>
            <div style={{ textAlign: "center", marginBottom: "5rem" }}>
              ...
              <h2 style={{ fontFamily: "var(--font-epilogue),sans-serif", fontWeight: 800, fontSize: "clamp(2.5rem,4vw,4rem)", textTransform: "uppercase", letterSpacing: "-.04em", lineHeight: 1.05, marginBottom: "1.25rem", color: D.heading }}>
                One Vision. <em style={{ color: "#C5A059", fontStyle: "italic" }}>Three Verticals.</em> Infinite Impact.
              </h2>
              <p style={{ color: D.muted, maxWidth: 560, margin: "0 auto", lineHeight: 1.8, fontSize: "1rem" }}>
                Three independent capabilities designed to work as one regenerative ecosystem — where land produces food, energy, and future communities in harmony.
              </p>
            </div>
            ...
            <div ref={cardsRef} className="svc-grid">
              {services.map(svc => (
                <div key={svc.num} className="svc-card"
                  style={{ background: "rgba(10,10,10,1)", border: "1px solid rgba(255,255,255,.07)", borderRadius: ".25rem", display: "flex", flexDirection: "column", gap: "1.5rem", padding: "2.5rem", opacity: 0, transition: "border-color .3s, transform .3s, box-shadow .3s" }}
                  onMouseEnter={e => { const el = e.currentTarget as HTMLDivElement; el.style.borderColor = "rgba(197,160,89,.3)"; el.style.transform = "translateY(-4px)"; el.style.boxShadow = "0 16px 48px rgba(0,0,0,.5)"; }}
                  onMouseLeave={e => { const el = e.currentTarget as HTMLDivElement; el.style.borderColor = "rgba(255,255,255,.07)"; el.style.transform = "translateY(0)"; el.style.boxShadow = "none"; }}>
                  ...
                  <div className="card-content">
                    <h3 style={{ fontFamily: "var(--font-epilogue),sans-serif", fontWeight: 700, fontSize: "1.25rem", letterSpacing: "-.02em", color: D.heading, marginBottom: ".5rem" }}>{svc.title}</h3>
                    <p style={{ fontFamily: "var(--font-label)", fontSize: ".58rem", fontWeight: 700, letterSpacing: ".18em", textTransform: "uppercase", color: "#C5A059" }}>{svc.tagline}</p>
                  </div>

                  <p className="card-content" style={{ color: D.body, fontSize: ".88rem", lineHeight: 1.8 }}>{svc.desc}</p>

                  <div className="card-content" style={{ display: "flex", flexDirection: "row", flexWrap: "wrap", gap: ".5rem" }}>
                    {svc.tags.map(tag => <span key={tag} className="svc-tag">{tag}</span>)}
                  </div>

                  <div className="card-content" style={{ marginTop: "auto", paddingTop: "1rem", borderTop: `1px solid ${D.border}` }}>
                    <button style={{ display: "inline-flex", alignItems: "center", gap: ".5rem", background: "none", border: "none", cursor: "pointer", fontFamily: "var(--font-label)", fontSize: ".6rem", fontWeight: 700, letterSpacing: ".2em", textTransform: "uppercase", color: "#C5A059", transition: "gap .25s" }}
                      onMouseEnter={e => ((e.currentTarget as HTMLButtonElement).style.gap = ".85rem")}
                      onMouseLeave={e => ((e.currentTarget as HTMLButtonElement).style.gap = ".5rem")}>
                      Explore More <span className="material-symbols-outlined" style={{ fontSize: 16 }}>arrow_forward</span>
                    </button>
                  </div>
                </div>
              ))}
            ...
            <div style={{ textAlign: "center", marginTop: "4rem", padding: "2.5rem", background: "rgba(197,160,89,.06)", border: "1px solid rgba(197,160,89,.15)", borderRadius: ".25rem" }}>
              <p style={{ fontFamily: "var(--font-epilogue),sans-serif", fontWeight: 700, fontSize: "clamp(1rem,2vw,1.4rem)", color: D.heading, marginBottom: ".5rem" }}>One Ecosystem. Infinite Possibilities.</p>
              <p style={{ color: D.muted, fontSize: ".88rem", lineHeight: 1.7, maxWidth: 560, margin: "0 auto" }}>
                Agriculture restores the land. Energy powers resilience. Communities sustain the future — together creating regenerative ecosystems designed for generations.
              </p>
              <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: ".85rem", marginTop: "1.5rem" }}>
                {["Integrated by Nature","Regenerative by Design","Sustainable by Integration","Built for Tomorrow"].map(tag => <span key={tag} className="svc-tag">{tag}</span>)}
              </div>
            </div>
          </W>
        </section>
        ...
        <section id="technology" ref={techRef} style={{ background: "transparent", padding: "clamp(4rem,8vw,8rem) 0" }}>
          <W>
            <div style={{ textAlign: "center", marginBottom: "4rem" }}>
              ...
              <h2 style={{ fontFamily: "var(--font-epilogue),sans-serif", fontWeight: 800, fontSize: "clamp(2.5rem,4vw,4rem)", textTransform: "uppercase", letterSpacing: "-.04em", lineHeight: 1, marginBottom: "1.25rem", color: D.heading }}>
            ...
            <div className="tech-grid">
              <div style={{ borderRadius: ".25rem", overflow: "hidden", border: "1px solid rgba(255,255,255,.08)", aspectRatio: "4/5" }}>
                <img src={technologyImg} alt="Technology" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
              </div>
              <div ref={techFeatRef} className="feat-grid">
                {techFeatures.map(feat => (
                  <div key={feat.title} className="feat-card"
                    ...
                    <h4 style={{ fontFamily: "var(--font-epilogue),sans-serif", fontWeight: 700, fontSize: ".9rem", textTransform: "uppercase", letterSpacing: "-.01em", color: D.heading }}>{feat.title}</h4>
                    <p style={{ color: D.muted, fontSize: ".8rem", lineHeight: 1.7 }}>{feat.desc}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="stats-bar">
              {[
                ...
                <div key={stat.label} style={{ display: "flex", flexDirection: "column", gap: ".5rem", padding: "clamp(1.25rem,2.5vw,2rem) clamp(1.5rem,3vw,2.5rem)", background: "#0a0a0a" }}>
                  ...
                  <span style={{ fontFamily: "var(--font-label)", fontWeight: 700, textTransform: "uppercase", fontSize: ".54rem", letterSpacing: ".2em", color: D.muted }}>{stat.label}</span>
                </div>
              ))}
            </div>
          </W>
        ...
        {/* SATELLITE INSIGHT */}
        <section ref={satRef} style={{ background: "transparent", padding: "clamp(4rem,8vw,8rem) 0", borderTop: "1px solid rgba(255,255,255,.06)", borderBottom: "1px solid rgba(255,255,255,.06)" }}>
          <W>
            <div className="sat-grid">
              <div>
                <h2 className="sat-anim" style={{ fontFamily: "var(--font-epilogue),sans-serif", fontWeight: 800, textTransform: "uppercase", letterSpacing: "-.045em", lineHeight: 0.95, fontSize: "clamp(3rem,4vw,4rem)", marginBottom: "2rem", opacity: 0, color: D.heading }}>
                  Satellite<br /><span style={{ color: "#C5A059" }}>Insight</span>
                </h2>
                <p className="sat-anim" style={{ color: D.muted, lineHeight: 1.8, maxWidth: 420, marginBottom: "3rem", fontSize: "1rem", opacity: 0 }}>
                ...
                <div className="sat-anim" style={{ display: "flex", flexDirection: "column", opacity: 0 }}>
                  {[["Coverage","Global"],["Update Cycle","Every 12h"],["Resolution","0.5m / px"]].map(([label, val]) => (
                    <div key={label} style={{ display: "flex", justifyContent: "space-between", padding: "1rem 0", borderBottom: "1px solid rgba(255,255,255,.06)" }}>
                      <span style={{ fontFamily: "var(--font-label)", fontWeight: 700, textTransform: "uppercase", fontSize: ".55rem", letterSpacing: ".18em", color: D.muted }}>{label}</span>
                      <span style={{ fontFamily: "var(--font-label)", fontWeight: 700, fontSize: ".7rem", color: "#C5A059" }}>{val}</span>
                    </div>
                  ))}
                </div>
              </div>
              <div className="sat-anim" style={{ borderRadius: ".25rem", overflow: "hidden", aspectRatio: "16/9", border: "1px solid rgba(255,255,255,.1)", boxShadow: "0 32px 80px rgba(0,0,0,.6)", opacity: 0 }}>
                <img
                  ...
                  alt="Satellite" style={{ width: "100%", height: "100%", objectFit: "cover", transition: "transform .7s" }}
        ...
        <section ref={pillarsRef} style={{ background: "transparent", padding: "clamp(4rem,8vw,8rem) 0" }}>
          <W>
            <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
              ...
              <h2 style={{ fontFamily: "var(--font-epilogue),sans-serif", fontWeight: 800, textTransform: "uppercase", letterSpacing: "-.045em", lineHeight: 1, fontSize: "clamp(2.5rem,4vw,4rem)", color: D.heading }}>
                Technological Pillars
              </h2>
            </div>
            ...
            <div className="pil-grid">
              ...
              <div className="pil-card"
                ...
                <img className="bg-img"
                  ...
                  alt="" style={{ position: "absolute", right: 0, bottom: 0, width: "60%", height: "100%", objectFit: "cover", objectPosition: "left", opacity: .18, pointerEvents: "none", transition: "opacity .7s" }} />
                <div style={{ position: "relative", zIndex: 1 }}>
                  ...
                  <h3 style={{ fontFamily: "var(--font-epilogue)", fontWeight: 700, textTransform: "uppercase", fontSize: "clamp(1.2rem,2vw,1.8rem)", letterSpacing: "-.02em", marginBottom: "1rem", color: D.heading }}>Data-Driven Agriculture</h3>
                  <p style={{ color: D.muted, fontSize: ".84rem", lineHeight: 1.75, maxWidth: 280 }}>Soil sensors, satellite imaging, and AI-powered crop health analysis for precision farming decisions.</p>
                </div>
              ...
              <div className="pil-card"
                ...
                <div>
                  ...
                  <h3 style={{ fontFamily: "var(--font-epilogue)", fontWeight: 700, textTransform: "uppercase", fontSize: "1.35rem", letterSpacing: "-.01em", marginBottom: "1rem", color: D.heading }}>Automation &amp; Monitoring</h3>
                  <p style={{ color: D.muted, fontSize: ".84rem", lineHeight: 1.75 }}>IoT-enabled real-time monitoring of irrigation, energy output, soil moisture, and micro-climate conditions.</p>
                </div>
                <div style={{ borderTop: "1px solid rgba(255,255,255,.06)", paddingTop: "1.5rem", marginTop: "1.5rem" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", marginBottom: ".75rem" }}>
                    <span style={{ fontFamily: "var(--font-label)", fontWeight: 700, textTransform: "uppercase", fontSize: ".55rem", letterSpacing: ".18em", color: D.muted }}>Active Nodes</span>
                    <span style={{ fontFamily: "var(--font-label)", fontWeight: 700, fontSize: ".7rem", color: "#C5A059" }}>14+</span>
                  </div>
              ...
              <div className="pil-card"
                ...
                <h3 style={{ fontFamily: "var(--font-epilogue)", fontWeight: 700, textTransform: "uppercase", fontSize: "1.25rem", letterSpacing: "-.01em", marginBottom: "1rem", color: D.heading }}>Carbon-Linked Systems</h3>
                <p style={{ color: D.muted, fontSize: ".84rem", lineHeight: 1.75, marginBottom: "1.5rem" }}>Verified carbon sequestration tracking and marketplace integration for tradeable carbon credits.</p>
                <div style={{ marginTop: "auto", height: 90, borderRadius: ".25rem", overflow: "hidden", border: "1px solid rgba(255,255,255,.06)" }}>
                  <img
                    ...
                    alt="Forest" style={{ width: "100%", height: "100%", objectFit: "cover", filter: "grayscale(1)", transition: "filter .5s" }}
              ...
              <div className="pil-card"
                ...
                <div className="pil-card-weather">
                  <div style={{ flex: 1 }}>
                    <h3 style={{ fontFamily: "var(--font-epilogue)", fontWeight: 700, textTransform: "uppercase", fontSize: "1.25rem", letterSpacing: "-.01em", marginBottom: "1rem", color: D.heading }}>Weather-Risk Mitigation</h3>
                    <p style={{ color: D.muted, fontSize: ".84rem", lineHeight: 1.75, marginBottom: "1.5rem" }}>Predictive weather modeling and adaptive systems that protect crops and optimise energy generation cycles.</p>
        ...
        <section ref={ctaRef} style={{ background: "transparent", padding: "clamp(3rem,6vw,6rem) 0 clamp(4rem,8vw,8rem)" }}>
          <W>
            <div className="cta-grid" style={{ borderRadius: ".25rem", padding: "clamp(2.5rem,5vw,6rem)", background: "#0d0d0d", border: "1px solid rgba(197,160,89,.15)" }}>
              <div>
                <SectionEyebrow text="Partner With Us" />
                <h2 className="c-anim" style={{ fontFamily: "var(--font-epilogue),sans-serif", fontWeight: 800, textTransform: "uppercase", letterSpacing: "-.04em", lineHeight: 1.05, fontSize: "clamp(2.5rem,4vw,4rem)", marginBottom: "1.5rem", opacity: 0, color: D.heading }}>
                  Ready to Architect<br /><span style={{ color: "#C5A059" }}>The Next Epoch?</span>
                </h2>
                <p className="c-anim" style={{ color: D.muted, maxWidth: 520, lineHeight: 1.8, fontSize: ".92rem", opacity: 0 }}>
              ...
              <div className="c-anim cta-btns" style={{ opacity: 0 }}>
                <a href="/connect" style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", gap: ".65rem", padding: "1.1rem 2.5rem", background: "#C5A059", color: "#000", fontFamily: "var(--font-label)", fontSize: ".62rem", fontWeight: 700, letterSpacing: ".2em", textTransform: "uppercase", textDecoration: "none", borderRadius: ".15rem", whiteSpace: "nowrap", transition: "filter .25s, transform .25s" }}
                  ...
                  Start Inquiry <span className="material-symbols-outlined" style={{ fontSize: 15 }}>arrow_forward</span>
                </a>
                <button style={{ padding: "1rem 2.5rem", background: "transparent", border: "1px solid rgba(255,255,255,.18)", color: D.body, fontFamily: "var(--font-label)", fontSize: ".62rem", fontWeight: 700, letterSpacing: ".2em", textTransform: "uppercase", cursor: "pointer", borderRadius: ".15rem", whiteSpace: "nowrap", transition: "all .3s" }}
                  onMouseEnter={e => { const b = e.currentTarget as HTMLButtonElement; b.style.borderColor = "rgba(255,255,255,.45)"; b.style.color = "#fff"; }}
                  onMouseLeave={e => { const b = e.currentTarget as HTMLButtonElement; b.style.borderColor = "rgba(255,255,255,.18)"; b.style.color = D.body; }}>
                  Download Report
                </button>
              </div>
            </div>
