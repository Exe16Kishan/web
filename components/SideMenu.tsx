      ...
      {isOpen && (
        <>
          <motion.div
            ...
            onClick={onClose}
            style={{ position: "fixed", inset: 0, zIndex: 59, background: "rgba(0,0,0,.55)", backdropFilter: "blur(4px)", WebkitBackdropFilter: "blur(4px)" }}
          />
          <motion.aside
            key="panel"
            initial={{ x: "-100%" }}
          ...
          >
            ...
            <nav style={{ flex: 1, padding: "1rem 0", display: "flex", flexDirection: "column" , justifyContent: "center"}}>
              {navLinks.map((link, i) => (
                <motion.div
                  key={link.href}
